...
| projects | axi-docs | Axi Docs | libu | active | active-canonical | agent/workspace-incubator | yes | `../../projects/axi-docs` | [link](https://github.com/axiomaticworld/axi-docs.git) |
...
| shared | axi-rules | Axi Rules | libu | active | active-shared-provider | agent/workspace-incubator | yes | `../../projects/axi-rules` | - |
...
| tools | axi-video-downloader | Axi Video Downloader | libu | active | active-tool | dev | yes | `../../tools/axi-video-downloader` | - |
