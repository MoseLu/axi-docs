...
mkdir -p /Volumes/code/workspace/projects/axi-docs/docs/content/{en,zh}/projects/dbskill
# 8 个文件用 Write 工具手工创建（模板沿用 build-projects-index.mjs 的 PIECE_TEMPLATES）

# codex-plus-app：拉入镜像（最小 3 件）
mkdir -p /Volumes/code/workspace/projects/axi-docs/docs/content/{en,zh}/projects/codex-plus-app
...
```bash
cd /Volumes/code/workspace/projects/axi-docs
