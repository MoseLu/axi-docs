...
LOG_DIR = r"D:\logs"
PROJECT_LOG = os.path.join(LOG_DIR, "info-hub.log")
FRONTEND_LOG = os.path.join(LOG_DIR, "info-hub-frontend.log")
...
class ProjectManager:
    ...
    def run(self):
        log("=" * 50)
        log("Info Hub Project Manager Started")
        log("=" * 50)
