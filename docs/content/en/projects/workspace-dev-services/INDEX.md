...
# Workspace Dev Services — Dossier Index
...
- Other locale: `docs/content/zh/projects/workspace-dev-services/`
- Workspace entry: `/Volumes/code/workspace/dev-services.config.json`
