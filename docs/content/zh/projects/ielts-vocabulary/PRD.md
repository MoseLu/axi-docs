...
# IELTS Vocabulary — PRD 切片

> Axi Docs 针对 **IELTS Vocabulary** 的 PRD 切片。这*不是*项目本身的 PRD，它记录的是 Axi Docs 用于呈现该项目自身的需求。

## REQ-PROJ-IELTS-VOCABULARY-001

| 字段 | 值 |
| --- | --- |
| Requirement | 为 IELTS Vocabulary 维护一份可被发现的 Axi Docs 档案。 |
| Acceptance | `docs/content/{en,zh}/projects/ielts-vocabulary/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONES.md, PRD.md, TDD.md` 均存在且 frontmatter 合法。 |
...
| Acceptance | `pnpm --dir app projects:check --project=ielts-vocabulary` 执行成功。 |
