...
- `pnpm --dir app projects:check` 会遍历 `docs/content/{en,zh}/projects/axi-tauri-starter/README.md, AGENTS.md, INDEX.md, TODO.md, MILESTONES.md, PRD.md, TDD.md`，并断言每个期望文件都存在且 frontmatter 有效。
