...
INFO_HUB_EXTRA_SOURCES_JSON=[{"id":"hermes-system","name":"Hermes-System","path":"/root/.hermes/knowledge/hermes-system","type":"local","enabled":true,"icon":"folder"}]
EOF
