...
onMounted(() => {
  ...
  if (cow) cow.style.animation = 'jmb 0.2s linear, move 2s linear'
  if (textBox) textBox.style.animation = 'textAnim 3.6s linear'
  if (homeBtn) homeBtn.style.animation = 'btnAnim 4s linear'
})
</script>
