...
| **Axi Docs** | `/Volumes/code/workspace/projects/axi-docs` | 「这个项目/技能/工作区**是什么**？」 | 文档枢纽 + 知识图谱 + MCP 文档总线。 |
...
```
| axi-docs | Axi Docs | projects | /Volumes/code/workspace/projects/axi-docs |
...
`/Volumes/code/workspace/projects/axi-docs`（`projects/` 分区，独立仓库）。
