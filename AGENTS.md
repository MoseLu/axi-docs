...
- **适用对象**：所有 agent（包括 Codex、Cursor、自动化扫描器、文档巡检子代理）首次接触 `/Volumes/code/workspace/projects/axi-docs` 时。
...
| `docs/content/en/` | 是 | 产品内容源（英文），frontmatter 含 `id/type/status/tags` |
