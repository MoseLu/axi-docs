...
const enDir = '/Volumes/code/workspace/projects/axi-docs/docs/content/en/projects';
const zhDir = '/Volumes/code/workspace/projects/axi-docs/docs/content/zh/projects';
