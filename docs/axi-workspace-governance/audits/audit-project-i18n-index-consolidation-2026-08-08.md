...
# 2) 重生成/校验 dossier
pnpm --dir /Volumes/code/workspace/projects/axi-docs/app projects:build
pnpm --dir /Volumes/code/workspace/projects/axi-docs/app projects:check

# 3) zh ↔ en 镜像差异
diff -rq \
  /Volumes/code/workspace/projects/axi-docs/docs/content/zh/projects \
  /Volumes/code/workspace/projects/axi-docs/docs/content/en/projects

# 4) 必选 7 件套脚本化扫描（输出 P0/P1）
cd /Volumes/code/workspace/projects/axi-docs/docs/content/zh/projects
for p in */; do
