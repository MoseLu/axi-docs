...
APP_ENV_FILE="${APP_ENV_FILE:-/root/.hermes/apps/info-hub/.env.server}"
...
APP_DIR="${APP_DIR:-/root/.hermes/apps/info-hub}"
...
BLINKO_RCLONE_REMOTE_PATH="${BLINKO_RCLONE_REMOTE_PATH:-info-hub/blinko-notes}"
